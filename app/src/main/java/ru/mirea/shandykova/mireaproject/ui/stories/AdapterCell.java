...
public class AdapterCell extends RecyclerView.Adapter<ru.mirea.shandykova.mireaproject.ui.stories.AdapterCell.StoryHolder>{
    List<ru.mirea.shandykova.mireaproject.ui.stories.Cell> stories;

    public AdapterCell(List<ru.mirea.shandykova.mireaproject.ui.stories.Cell> stories){
    ...
    class StoryHolder extends RecyclerView.ViewHolder{
        ...
        void bind(int listIndex){
            ru.mirea.shandykova.mireaproject.ui.stories.Cell cell = stories.get(listIndex);
